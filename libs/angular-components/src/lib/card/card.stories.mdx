...
<Meta
  ...
  argTypes={{
    content: {
      description: 'Content inside of the oa-card-content-old component.',
      control: 'text',
    },
    headerContent: {
...
<Canvas>
  ...
  >
    {(args) => {
      return {
        template: `<goa-card-old [cardSize]="cardSize">
    ...
    {(args) => {
      return {
        template: `<div style="display:flex;">
                      <goa-card-old style="margin: 28px; width:200px;">
                          <goa-card-thumb-image url="working-in-cold-hero-3_rdax_75.jpg" alt="hero pic"></goa-card-thumb-image>
                          <goa-card-header>Energy Diversification Act</goa-card-header>
                          <goa-card-content-old>Fixed width.  Height scales to parent container.</goa-card-content-old>
                        <goa-card-footer>
                          <button style="margin: 12px 12px 0 0;" goa-button buttonSize="small" buttonType="tertiary">Action 1</button>
                          <button style="margin: 12px 12px 0 0;" goa-button buttonSize="small" buttonType="tertiary">Action 2</button>
                        </goa-card-footer>
                      </goa-card-old>
                      <goa-card-old style="margin: 28px;">
                          <goa-card-thumb-image url="working-in-cold-hero-3_rdax_75.jpg" alt="hero pic"></goa-card-thumb-image>
                          <goa-card-header>Energy Diversification Act</goa-card-header>
                          <goa-card-content-old>Auto width.</goa-card-content-old>
                        <goa-card-footer>
                          <button style="margin: 12px 12px 0 0;" goa-button buttonSize="small" buttonType="tertiary">Action 1</button>
                          <button style="margin: 12px 12px 0 0;" goa-button buttonSize="small" buttonType="tertiary">Action 2</button>
                        </goa-card-footer>
                      </goa-card-old>
                      <goa-card-old style="flex: 1 0 0; margin: 28px;">
                          <goa-card-thumb-image url="working-in-cold-hero-3_rdax_75.jpg" alt="hero pic"></goa-card-thumb-image>
                          <goa-card-header>Energy Diversification Act</goa-card-header>
                          <goa-card-content-old>Flex grow.  Note, when card uses cardImage the image height will scale to maintain aspect ratio.</goa-card-content-old>
                        <goa-card-footer>
                          <button style="margin: 12px 12px 0 0;" goa-button buttonSize="small" buttonType="tertiary">Action 1</button>
                          <button style="margin: 12px 12px 0 0;" goa-button buttonSize="small" buttonType="tertiary">Action 2</button>
                        </goa-card-footer>
...
<div style="display:flex;">
  <goa-card-old style="margin: 28px; width:200px;">
    ...
    <goa-card-content-old
      ...
      to maintain aspect ratio.</goa-card-content-old
    >
    <goa-card-footer
      ><button goa-button buttonSize="small" buttonType="tertiary">
        Action 1
  ...
  <goa-card-old style="flex: 1 0 0; margin: 28px;">
    ...
    ></goa-card-thumb-image>
    <goa-card-header>Energy Diversification Act</goa-card-header>
    <goa-card-content-old>Flex grow.</goa-card-content-old>
    <goa-card-footer
      ><button goa-button buttonSize="small" buttonType="tertiary">
        Action 1
      </button></goa-card-footer
